...
**自己也能反推坐标系**：用下面的小脚本看坐标范围。若 X 在 38 万~62 万、Y 在几百万（如 580488, 3609788），就是高斯投影、假东 500000；中央子午线 = 把厂区大致经度按 3° 取整（广元 105.8°E → `cgcs2000-3-105`）；Y/1e6 约 = 纬度（3609788 → 32.6°N）。转完用 Google Earth 打开 KML，落点对的就说明 CS 没填错。
